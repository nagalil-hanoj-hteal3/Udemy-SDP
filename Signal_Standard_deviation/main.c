...
double calculate_signal_std(double sig_variance);
...
int main()
{
    ...
    STD = calculate_signal_std(VARIANCE);
    printf("\nStandard Deviation of our waveforms equals: %f\n\n", STD);
...
/*
@param: sig_variance to obtain the signal variance

@about: calculate the signal standard deviation.
*/
double calculate_signal_std(double sig_variance)
{
